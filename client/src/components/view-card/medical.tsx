                            ...
                            <div className="flex justify-start pt-3">
                                <div className="w-[40%] bg-white rounded-xl shadow-xl">
                                    ...
                                    <div className="flex justify-center pb-3">
                                        <button className="w-[90%]  text-black rounded-lg">
                                            {card?.emergencyPhone}
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div className="basis-1/2 flex justify-start">
                            <div className="bg-white w-[80%] p-4 rounded-3xl shadow-xl">
                                ...
                                <div className="flex flex-row text-slate-500">
                                    ...
                                    <div className="basis-1/2">
                                        <div className="w-full">{card?.street}</div>
                                ...
                                <div className="flex flex-row text-slate-500">
                                    <div className="basis-1/2 flex justify-center">City:</div>
                                    <div className="basis-1/2">
                                        <div className="w-full">{card?.city}</div>
                                    </div>
                                </div>
                                <div className="flex flex-row text-slate-500">
                                    <div className="basis-1/2 flex justify-center">State:</div>
                        ...
                        <div className="flex justify-center">
                            <div className="flex justify-center pb-4 w-[90%] ml-4 mt-4">
                                <div className="w-full pl-4">
                                    ...
                                    <div className="w-[80%] pl-2 py-2">
                                        <div className="w-full flex pl-4 py-2 rounded-lg text-white font-Kanit bg-blue-400 shadow-xl" >{card?.allergyHistory}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-center">
                            <div className="flex justify-center pb-4 w-[90%] ml-4">
                                <div className="w-full pl-4">
                                    ...
                                    <div className="w-[80%] pl-2 py-2">
                                        <div className="w-full flex pl-4 py-2 rounded-lg text-white font-Kanit bg-blue-400 shadow-xl">{card?.chronicHistory}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-center">
                            <div className="flex justify-center pb-4 w-[90%] ml-4">
                                <div className="w-full pl-4">
                                    ...
                                    <div className="w-[80%] pl-2 py-2">
                                        <div className="w-full flex pl-4 py-2 rounded-lg text-white font-Kanit bg-blue-400 shadow-xl">{card?.currentMedication}</div>
                                    ...
                                    {healthHabits.map((health, idx) => (
                                        <>
                                            <div className="mt-2" key={idx}>
                                                ...
                                                <div className="w-[80%] pl-2 py-2">
                                                    <div className="w-full flex pl-4 py-2 rounded-lg text-white font-Kanit bg-blue-400 shadow-xl" >{health.value}</div>
                                                </div>
                                            </div>
                                        </>
                                    ))}
