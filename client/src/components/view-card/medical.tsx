...
const MedicalComponent = ({ card }: PropsType) => {
    const birthDate = card?.personalInfo.birth ? new Date(card.personalInfo.birth) : null;
            ...
            <div className="w-[90%] bg-slate-300 mt-[6rem] rounded-3xl shadow-xl">
                ...
                <div className="flex justify-center py-4">
                    <div className="w-[80%] bg-white p-4 rounded-xl shadow-xl">
                        ...
                        <div className="text-slate-500">
                            <p className="pl-2">
                                {card?.personalInfo?.address?.street}
                            </p>
                        </div>
                ...
                <div className="flex justify-center pb-4 -mt-1">
                    <div className="w-[90%] pl-4">
                        ...
                        <div className="w-[80%] pl-2 py-2">
                            <input type="text" className="w-full flex justify-center pl-4 py-2 rounded-lg text-white font-Kanit bg-blue-400 shadow-xl" readOnly defaultValue={card?.healthHistory.allergy} />
                        </div>
                    </div>
                </div>
                {/* chronic */}
                <div className="flex justify-center pb-4 -mt-1">
                    <div className="w-[90%] pl-4">
                        ...
                        <div className="w-[80%] pl-2 py-2">
                            <input type="text" className="w-full flex justify-center pl-4 py-2 rounded-lg text-white font-Kanit bg-blue-400 shadow-xl" readOnly defaultValue={card?.healthHistory.chronic} />
                        </div>
                    </div>
                </div>
                {/* current medications */}
                <div className="flex justify-center pb-4 -mt-1">
                    <div className="w-[90%] pl-4">
                        ...
                        <div className="w-[80%] pl-2 py-2">
                            <input type="text" className="w-full flex justify-center pl-4 py-2 rounded-lg text-white font-Kanit bg-blue-400 shadow-xl" readOnly defaultValue={card?.currentMedication} />
                        </div>
                    </div>
                </div>
                {/* health habits */}
                <div className="flex justify-center pb-4 -mt-1">
                    <div className="w-[90%] pl-4">
                        ...
                        <div className="w-[80%] pl-2 py-2">
                            <input type="text" className="w-full flex justify-center pl-4 py-2 rounded-lg text-white font-Kanit bg-blue-400 shadow-xl" readOnly defaultValue={health.value} />
                        </div>
                            </div>
                            </>
                        ))}
