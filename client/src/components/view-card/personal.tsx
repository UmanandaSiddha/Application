                            ...
                            <div className="flex justify-center">
                                <div className="w-[90%] bg-white flex flex-col items-center py-4 rounded-2xl shadow-2xl">
                                    ...
                                    {lifestyles ? (
                                        <div
                                            id="dropdown"
                                            className="relative bg-slate-100 divide-gray-100 rounded-lg shadow-lg w-[80%] dark:bg-gray-700 py-2 mt-4 mb-2 flex justify-center"
                                        >
                                            <ul
                                                ...
                                                {lifestyles && (
                                                    <div className="flex flex-col space-y-2">
                                                        {lifestyless.map((life, idx) => (
                                                            ...
                                                            >
                                                                <div className="basis-1/3 flex justify-center items-center text-lg text-slate-900">
                                                                ...
                                                                <div className="basis-2/3 px-4">
                                                                    <input
                                                                        type="text"
                                                                        className="block py-2.5 px-0 w-full text-base font-Kanit bg-transparent border-0 border-b-2 border-black appearance-none text-slate-900 focus:outline-none focus:ring-0 focus:border-blue-600"
                                                                        // readOnly
                                                                        disabled
                                                                        value={life?.value}
                                                                    />
                                    ...
                                    {fav ? (
                                        <div
                                            id="dropdown"
                                            className="relative bg-slate-100 divide-gray-100 rounded-lg shadow-lg w-[80%] dark:bg-gray-700 mt-2 py-4"
                                        >
                                            <ul
                                    ...
                                    {misc ? (
                                        <div
                                            id="dropdown"
                                            className="relative bg-slate-100 divide-gray-100 rounded-lg shadow w-[80%] dark:bg-gray-700 mt-4 py-2"
                                        >
                                            <ul
                                                className=" text-sm text-gray-900 dark:text-gray-200"
                                                aria-labelledby="dropdownDefaultButton"
                                    ...
                                    {interest ? (
                                        <div
                                            id="dropdown"
                                            className="relative bg-slate-100 divide-gray-100 rounded-lg shadow w-[80%] dark:bg-gray-700 mt-4 py-4"
                                        >
                                            <ul
                                                className=" text-sm text-gray-900 dark:text-gray-200"
                                                aria-labelledby="dropdownDefaultButton"
