                    ...
                    <div className="flex flex-col items-center md:items-start">
                        <h2 className="text-white text-2xl font-medium">
                            <div className="flex items-center justify-center space-x-2 -m-1.5 p-1.5">
                                <img className="sm:h-8 h-7 sm:w-full w-28" src="/voolata_long_w_r.png" alt="" />
                            </div>
                        </h2>
                        ...
                        <div className="flex justify-center md:justify-start gap-4 mt-4">
                            <svg className="w-10 h-10 fill-current text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
