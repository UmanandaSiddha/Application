...
const ResetPassword = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Voolata | Reset Password</title>
                <meta name="description" content={`This is the reset password page of Voolata`} />
                <meta name="keywords" content="reset, password, voolata" />
            </Helmet>
