...
const OrgRegister = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Voolata | Organisation Register</title>
                <meta name="description" content={`This is the organisation register page of Voolata`} />
                <meta name="keywords" content="organisation, register, voolata" />
            </Helmet>
