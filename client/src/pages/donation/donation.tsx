            ...
            <div className="container px-1 py-10 mx-auto">
                <div className="lg:flex lg:items-center">
                    <div className="w-full space-y-8 lg:w-1/2 ">
                        <div>
                            <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Donate for a cause</h1>
                ...
                <div className="flex justify-center items-center pt-8">
                    <button onClick={() => navigate("/donation/dashboard")} className="py-2 px-4 border-2 text-xl text-bold text-white border-blue-500 bg-blue-500 rounded-md hover:bg-white hover:text-blue-500 shadow-md">Donate Now</button>
                </div>
            </div>
        </section>
    );
