                    ...
                    <div className="mt-10 space-y-6 w-full">
                        ...
                        <div className="border w-[90%] lg:w-[60%] px-6 py-2 shadow-xl rounded-lg bg-slate-100">
                            <Link to="/donation/billing" className="inline-flex items-center text-sm text-blue-500 gap-x-2 dark:text-blue-400 hover:underline">
                                <span className="text-xl">Your Donations</span>
                        ...
                        <div className="flex items-center my-16 gap-x-4">
                            <button onClick={() => navigate("/")} className="w-1/7 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                                Take me home
                            </button>

                            <button disabled={logoutLoading} onClick={handleLogout} className="w-1/7 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-gray-500 rounded-lg shrink-0 sm:w-auto hover:bg-gray-600 dark:hover:bg-gray-500 dark:bg-gray-600">
