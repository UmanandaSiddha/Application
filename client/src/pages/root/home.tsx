...
const HomePage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Voolata | {location.pathname === "/about-us" ? "About Us" : "Home"}</title>
                <meta name="description" content={`This is the ${location.pathname === "/about-us" ? "about" : "home"} page of Voolata`} />
                <meta name="keywords" content="home, voolata" />
            </Helmet>
            ...
            <div className="flex flex-col relative items-center hide-scrollbar ">
                ...
                <div className="flex flex-col sm:pt-20 pt-10 z-10 justify-center items-center mx-auto gap-14 sm:w-[80%]">
                    ...
                    <div className='flex items-center gap-4'>
                        <button className="uppercase bg-purple-800 text-sm sm:text-lg text-white sm:h-16 md:w-48 w-28 h-14 font-semibold rounded-lg">
                            <Link to={'/dashboard/botanical'}>Get Started</Link>
                        </button>
                ...
                <div className=' flex items-center gap-10 w-[80%] sm:pt-16 pb-24'>
                    ...
                    <img src="./project_final.png " loading="lazy" alt="" className='w-96 max-lg:hidden' />
                </div>
                ...
                <div className="w-[90%] sm:pt-10 sm:pb-20">
                    <p className='md:text-3xl pt-20 pb-16 text-lg text-justify sm:text-center'>
