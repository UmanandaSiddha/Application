                ...
                <div className="flex flex-row justify-center gap-8 lg:gap-2 items-center  ">
                    {user ? (
                        <div className="w-full lg:flex lg:flex-row lg:max-h-screen">
                            <div className="bg-blue-400 py-[4rem] lg:pt-6 lg:mt-12 flex flex-row rounded-b-[5rem] lg:rounded-[2rem] lg:shadow-2xl lg:ml-4 lg:basis-1/2 lg:bg-slate-500 lg:bg-cover">
                                    ...
                                    <div className="py-4">
                                        <div className="flex flex-row">
                                            <div className="basis-1/4 flex justify-end">
                                                <div>
                                                    {user.image ? (
                                                        <p className="h-12 w-12 rounded-full text-center">
                                                            {user.name.charAt(0)}
                                                        </p>
                                                        // <img className="h-20 w-20 rounded-full" src={user.image} alt={user._id} />
                                                    ) : (
                                                        <p className="h-12 w-12 rounded-full text-center">
                                                            {user.name.charAt(0)}
                                                        </p>
