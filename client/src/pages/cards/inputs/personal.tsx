...
const miscellaneous = [
  ...
  },
  {
    ...
    text: "Enter Dietary Preferences",
...
const interests = [
  {
    ...
    customInput: { name: "prefOther", text: "Enter custom preference mode" },
  },
  {
    name: "genre",
    ...
    customInput: { name: "genreOther", text: "Enter custom genre" },
  },
  {
    name: "sports",
    ...
    customInput: { name: "sportOther", text: "Enter custom activities" },
  },
  {
    name: "artistisPursuits",
    ...
    customInput: { name: "artOther", text: "Enter custom hobbies" },
  },
  {
    name: "gaming",
    ...
    customInput: { name: "gamingOther", text: "Enter custom preference" },
  },
  {
    name: "collectignHobby",
    ...
    customInput: { name: "collectingOther", text: "Enter custom interest" },
  },
  {
    name: "coffee",
    label: "Coffee or Tea?",
    ...
    customInput: { name: "coffeeOther", text: "Enter custom coffee" },
  },
  {
    name: "cookingSkills",
    ...
    customInput: { name: "cookOther", text: "Enter custom skill" },
  },
];
...
const professional = [
  {
    ...
    customInput: { name: "occupationOther", text: "Enter custom occupation" },
  },
  {
    name: "careerAspiation",
    label: "Career Aspiation",
    ...
    customInput: { name: "aspirationOther", text: "Enter custom aspiration" },
  },
  {
    name: "education",
    ...
    customInput: { name: "backgroundOther", text: "Enter custom background" },
  },
  {
    name: "skills",
    ...
    customInput: { name: "expertiseOther", text: "Enter custom expertise" },
  },
];
    ...
    switch (progressBar) {
      case 1:
        return (
          <div className="flex flex-col justify-center items-center my-8">
            ...
            {/* socials */}
            <div className="flex flex-col space-y-2 font-Kanit lg:mt-[1rem] lg:w-[40%]">
              <div className="lg:flex lg:justify-center">
                <h1 className="font-semibold text-lg font-Philosopher underline">
            ...
            {/* conatct */}
            <div className="pl-6 lg:w-[55%] my-4">
              <div className="flex justify-center mb-4">
                <h1 className="font-Philosopher text-xl underline">
                  Contact Numbers
                </h1>
              </div>
                ...
                <div key={index}>
                  <div className="flex flex-row" key={index}>
                    ...
                    <div className="basis-2/3 px-4">
                      <input
                        type={contact.type}
                        className="block py-2.5 px-0 w-full text-base font-Philosopher bg-transparent border-0 border-b-2 border-slate-300 appearance-none text-slate-300 focus:outline-none focus:ring-0 focus:border-blue-600 pl-2"
            ...
            {/* email */}
            <div className="pl-6 lg:w-[55%] mt-[1.5rem]">
              <div className="flex justify-center mb-4">
                <h1 className="font-Philosopher text-xl underline">
                  Email Addresses
                </h1>
      ...
      case 2:
        return (
          <div className="flex flex-col justify-center items-center my-8">
            ...
            {/* Favourites section */}
            <div className="pl-10 mt-2 lg:w-[54%]">
              <div className="flex justify-center my-4">
                <h1 className="underline font-Philosopher text-xl">
            ...
            {/* misc section */}
            <div className="pl-10 mt-4 lg:w-[55%] ">
              <div className="flex justify-center my-4">
                <h1 className="underline font-Philosopher text-xl">
                  ...
                  <div className="py-1" key={index}>
                    <div className="flex flex-row" key={index}>
                      ...
                      <div className="basis-2/3 px-4 flex items-center">
                        <select
                          className="w-[75%] rounded-lg text-black border-2 border-black"
                          {...register(miscs.name, {
                            required: true,
                            onChange: (e) => {
      ...
      case 3:
        return (
          <div className="flex flex-col justify-center items-center my-8">
            <div>
              <div className="pl-6 lg:w-[full]">
                <div className="flex justify-center my-4">
                  <h1 className="underline font-Philosopher text-xl">Mottos</h1>
                </div>
                {motto.map((life, index) => (
                  <div key={index}>
                    <div className="flex flex-row lg:w-full" key={index}>
                      <div className="basis-1/3 flex justify-center items-center text-lg">
                        <label htmlFor="" className="text-black">
                          {life.label}
                        </label>
                      ...
                      <div className="basis-2/3 px-4">
                        <input
                          type="text"
                          className="block py-2.5 px-0 w-full text-base font-Philosopher bg-transparent border-0 border-b-2 border-slate-300 appearance-none text-slate-600 focus:outline-none focus:ring-0 focus:border-blue-600 pl-2"
                          placeholder={life.text}
                          {...register(life.name, {
                            required: true,
                          })}
            ...
            <div className="w-full lg:w-[50%] lg:flex lg:justify-center my-[1.5rem]">
              <h1 className="text-3xl pl-6 font-Philosopher underline">
          ...
          <div>
            <div className="flex flex-col justify-center items-center my-8">
              ...
              <div className="w-full pt-6">
                ...
                <div className="lg:flex lg:justify-center mt-[1rem]">
                  <div className="pt-2">
                        ...
                        <div key={index}>
                          <div className="flex flex-row py-2 lg:gap-10">
                            ...
                            <div className="basis-2/3 px-4 flex items-center lg:justify-start lg:w-[50%]">
                              <select
                                className="w-full rounded-lg text-black items-center text-base lg:w-[70%] border-2 border-black"
                                {...register(prof.name, {
                                  required: true,
                                  onChange: (e) => {
                                    if (e.target.value !== "Other") {
              ...
              <div>
                <div className="pl-6 mt-2 ">
                  <div className="flex justify-center my-4">
                    <h1 className="underline font-Philosopher text-2xl">
                      Personal Values
                    </h1>
                  </div>
  ...
  return (
    <div className="flex flex-col justify-center items-center my-8">
      <div className="flex justify-center lg:mt-4 lg:flex lg:justify-center">
        <div className="w-[90%] h-4 bg-gray-300 rounded-full lg:w-[90%]">
          <div
      ...
      <form
        ...
        className="space-y-8 font-Kanit w-full"
      >
        <div className="space-y-4">{formParts()}</div>
        ...
        <div className="footer flex">
          <div className="basis-1/2 flex justify-center">
            <button
              ...
              className="disabled:hover:cursor-not-allowed bg-black text-white font-Philosopher rounded-md hover:cursor-pointer px-6 py-1"
              onClick={() => {
          ...
          <div className="basis-1/2 flex justify-center">
            <button
              ...
              className="disabled:hidden bg-black text-white font-Philosopher rounded-md hover:cursor-pointer px-6 py-1"
              onClick={() => {
                setProgressBar((currPage) => currPage + 1);
              }}
            >
            ...
            {progressBar === 5 && (
              <button type="submit" disabled={personalLoading} className="disabled:hidden bg-black text-white font-Philosopher rounded-md hover:cursor-pointer px-6 py-1">
