...
const RefundPolicyPage: React.FC = () => {
    return (
        <>
            <Helmet>
                <title>Voolata | Refund Policy</title>
                <meta name="description" content={`This is the refund policy page of Voolata`} />
                <meta name="keywords" content="refund policy, voolata" />
            </Helmet>
