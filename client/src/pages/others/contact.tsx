            ...
            <div className="container flex flex-col min-h-screen px-6 py-12 mx-auto">
                <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
                    ...
                    <div className="mt-8 lg:w-1/2 lg:mx-6">
                        <div className="w-full px-8 py-10 mx-auto overflow-hidde shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                            ...
                            <form onSubmit={handleSubmit} className="mt-4">
                                ...
                                <div className="flex-1 mt-6">
                                    ...
                                    <input 
                                        type="email" 
                                        placeholder="chatrapati@example.com" 
